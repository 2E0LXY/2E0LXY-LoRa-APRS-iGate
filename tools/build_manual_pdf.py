...
def page_decor(canvas, doc):
    ...
    canvas.drawRightString(width - 16 * mm, height - 9.5 * mm, "Heltec V3.2/V4 + LilyGO - Firmware v1.1.7")
...
cover = Table(
    [[Paragraph("2E0LXY", styles["CoverTitle"])],
     ...
     [Paragraph("UK 439.9125 MHz profile - Firmware v1.1.7 - July 2026", styles["CoverSub"])]],
    colWidths=[doc.width],
